...
/**
 * When the following events occur, notification messages should be
 * displayed on the screen of each player that is involved in the game (player or observer).
 *
 *     A user connected to the game as a player (black or white).
 *     The notification message should include the player’s name
 *     and which side they are playing (black or white).
 *     A user connected to the game as an observer.
 *     The notification message should include the observer’s name.
 *     A player made a move. The notification message should include
 *     the player’s name and a description of the move that was made.
 *     (This is in addition to the board being updated on each player’s screen.)
 *     A player left the game. The notification message should include
 *     the player’s name.
 *     A player resigned the game. The notification message should
 *     include the player’s name.
 *     A player is in check. The notification message should include
 *     the player’s name (this notification is generated by the server).
 *     A player is in checkmate. The notification message should include
 *     the player’s name (this notification is generated by the server).
 */
